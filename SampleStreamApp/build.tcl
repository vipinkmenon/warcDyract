...
#
# build.tcl: Tcl script for re-creating project 'dyractStream'
#
...
if {$argc > 0} {
    ...
    create_project -force dyractStream $origin_dir/$argv
} else {
    create_project -force dyractStream $origin_dir
}
...
set obj [get_projects dyractStream]
...
set file "$origin_dir/dyractStream.srcs/sources_1/bd/design_1/design_1.bd"
