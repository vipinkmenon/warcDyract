...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net sys_reset_n_0_1 [get_bd_ports sys_reset_n] [get_bd_pins dyractStream_0/sys_reset_n]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins dyractStream_0/i_rd_data_valid] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins dyractStream_0/i_rd_data] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins dyractStream_0/i_wr_data_ready] [get_bd_pins xlconstant_2/dout]
