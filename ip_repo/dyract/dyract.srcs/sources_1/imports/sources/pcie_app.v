...
rx_engine #(
  ...
  reg_file reg_file (
    ...
    .i_config_done(1'b0),//config_done
...
(
    ...
    .reg_data_i(reg_data),
    //config control
    .config_dma_req_i(1'b0),//config_rd_req
    .config_dma_rd_addr_i(32'd0),//config_rd_req_addr
    .config_dma_req_len_i(13'd0),//config_rd_req_len
    .config_dma_req_done_o(config_rd_req_ack),
    .config_dma_req_tag_i(8'd0),//config_req_tag 
    //DRA 
